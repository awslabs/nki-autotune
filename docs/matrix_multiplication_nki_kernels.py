...
if __name__ == "__main__":
    ...
    ###################################################
    # Autotune the Kernel nki_matmul_fully_optimized_ #
    ###################################################

    print("Autotuning nki_matmul_fully_optimized")
    ...
    tuned_func = nki.autotune(configs=get_autotune_configs())(
        nki_matmul_fully_optimized_
    )
    tuned_func(lhsT, rhs, output)
