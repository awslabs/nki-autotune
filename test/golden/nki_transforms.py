"""Golden test data for OperandMergeTransform: DMA merge, compute merge, activation merge."""
...
DMA_MERGE_OPTIONS = [TransformOption(StmtRef("_block_0", 1), StmtRef("_block_0", 3))]
...
COMPUTE_MERGE_OPTIONS = [TransformOption(StmtRef("_block_0", 5), StmtRef("_block_0", 7))]
...
ACTIVATION_MERGE_OPTIONS = [TransformOption(StmtRef("_block_0", 3), StmtRef("_block_0", 5))]
