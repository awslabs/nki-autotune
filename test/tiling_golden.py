...
def tiled_matmul(a, b):
    ...
    tensor_2 += nkigym.nc_matmul(tensor_3, tensor_4)
    output[0:128, 0:128] = tensor_2
...
def tiled_matmul(a, b):
    ...
    tensor_14 = nkigym.nc_matmul(tensor_12, tensor_13)
...
def tiled_matmul(a, b):
    ...
    tensor_2 += nkigym.nc_matmul(tensor_5, tensor_6)
    tensor_7 = a[384:512, 0:128]
    tensor_8 = b[384:512, 0:128]
    tensor_2 += nkigym.nc_matmul(tensor_7, tensor_8)
    tensor_9 = a[512:640, 0:128]
    tensor_10 = b[512:640, 0:128]
    tensor_2 += nkigym.nc_matmul(tensor_9, tensor_10)
    tensor_11 = a[640:768, 0:128]
    tensor_12 = b[640:768, 0:128]
    tensor_2 += nkigym.nc_matmul(tensor_11, tensor_12)
    tensor_13 = a[768:896, 0:128]
    tensor_14 = b[768:896, 0:128]
    tensor_2 += nkigym.nc_matmul(tensor_13, tensor_14)
    tensor_15 = a[896:1024, 0:128]
    tensor_16 = b[896:1024, 0:128]
    tensor_2 += nkigym.nc_matmul(tensor_15, tensor_16)
    output[0:128, 0:128] = tensor_2
...
def tiled_double_matmul(a, b, c):
    ...
    tensor_4 += nkigym.nc_matmul(tensor_7, tensor_8)
    output[0:128, 0:128] = tensor_4
...
def tiled_double_matmul(a, b, c):
    ...
    tensor_13 = nkigym.nc_matmul(tensor_11, tensor_12)
    tensor_14 = a[0:128, 128:256]
    tensor_15 = b[0:128, 0:128]
    tensor_16 = nkigym.nc_matmul(tensor_14, tensor_15)
    tensor_17 = c[128:256, 128:256]
    tensor_13 += nkigym.nc_matmul(tensor_16, tensor_17)
    output[0:128, 128:256] = tensor_13
