...
from src.cache.directories import BASELINE_CACHE_DIR, TORCH_CACHE_DIR, TUNED_CACHE_DIR, VISUALIZATION_DIR
...
if __name__ == "__main__":
    nki_baseline = pickle.load(
        open(f"{BASELINE_CACHE_DIR}/nki_matmul_fully_optimized_/nki_matmul_fully_optimized_.pkl", "rb")
    )
    torch_baseline = pickle.load(open(f"{TORCH_CACHE_DIR}/matmul/matmul.pkl", "rb"))
    tuned_data = read_tuning_data(TUNED_CACHE_DIR)
