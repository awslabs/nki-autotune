...
WORKLOADS = (
    {
        "accuracy": AccuracySpec(atol=1e-05, rtol=0.02, mode="global_max", output_indices=None, output_tolerances=()),
    ...
    {
        "accuracy": AccuracySpec(atol=1e-05, rtol=0.02, mode="global_max", output_indices=None, output_tolerances=()),
        "torch_ref": replace(_torch_ref_0_lnc1, arithmetic="native", matmul_input_dtype="bfloat16"),
        "input_specs": {
    ...
    {
        "accuracy": AccuracySpec(atol=1e-05, rtol=0.03, mode="global_max", output_indices=None, output_tolerances=()),
        "torch_ref": replace(_torch_ref_1, arithmetic="native", matmul_input_dtype="bfloat16"),
        "input_specs": {
    ...
    {
        "accuracy": AccuracySpec(atol=1e-05, rtol=0.04, mode="global_max", output_indices=None, output_tolerances=()),
        "torch_ref": replace(_torch_ref_2, arithmetic="native", matmul_input_dtype="bfloat16"),
        "input_specs": {
    ...
    {
        "accuracy": AccuracySpec(atol=1e-05, rtol=0.04, mode="global_max", output_indices=None, output_tolerances=()),
        "torch_ref": replace(_torch_ref_4, arithmetic="native", matmul_input_dtype="bfloat16"),
        "input_specs": {
    ...
    {
        "accuracy": AccuracySpec(atol=1e-05, rtol=0.03, mode="global_max", output_indices=None, output_tolerances=()),
        "torch_ref": replace(_torch_ref_5, arithmetic="native", matmul_input_dtype="bfloat16"),
        "input_specs": {
            "hidden_tensor": ((1, 1, 16384), "bfloat16"),
            "gate_proj_weights_tensor": ((16384, 896), "float8_e4m3"),
            "up_proj_weights_tensor": ((16384, 896), "float8_e4m3"),
