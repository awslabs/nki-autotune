...
WORKLOADS = (
    {
        "accuracy": AccuracySpec(
            ...
            output_tolerances=(),
            output_views=(
                (0, (16, 129), (slice(None, None, None), slice(0, 128, None))),
                (0, (16, 129), (slice(None, None, None), slice(128, 129, None))),
            ),
            output_groups=(),
        ),
    ...
    },
    {
        "accuracy": AccuracySpec(
            ...
            output_tolerances=(),
            output_views=(
                (0, (32, 257), (slice(None, None, None), slice(0, 256, None))),
                (0, (32, 257), (slice(None, None, None), slice(256, 257, None))),
            ),
            output_groups=(),
        ),
        "torch_ref": _torch_ref_0,
