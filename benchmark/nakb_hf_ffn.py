...
_torch_ref_0 = TorchReference(
    hf_ffn_nonorm_sm_torch_ref,
    ("x_hf", "w_in_hf", "w_out_hf", "b_in_col"),
    activation_storage_dtype="bfloat16",
    activation_residency="sbuf",
)


WORKLOADS = (
    {
        "accuracy": AccuracySpec(atol=0.1, rtol=0.05, mode="global_max", output_indices=None, output_tolerances=()),
