...
WORKLOADS = (
    ...
    {
        "accuracy": AccuracySpec(atol=1e-05, rtol=0.02, mode="global_max", output_indices=None, output_tolerances=()),
        "torch_ref": replace(_torch_ref_3, arithmetic="native", matmul_input_dtype="bfloat16"),
        "input_specs": {
    ...
    {
        "accuracy": AccuracySpec(atol=1e-05, rtol=0.02, mode="global_max", output_indices=None, output_tolerances=()),
        "torch_ref": replace(_torch_ref_7, arithmetic="native", matmul_input_dtype="bfloat16"),
        "input_specs": {
    ...
    {
        "accuracy": AccuracySpec(atol=1e-05, rtol=0.02, mode="global_max", output_indices=None, output_tolerances=()),
        "torch_ref": replace(_torch_ref_9, arithmetic="native", matmul_input_dtype="bfloat16"),
        "input_specs": {
            "hidden": ((1, 1, 8192), "bfloat16"),
