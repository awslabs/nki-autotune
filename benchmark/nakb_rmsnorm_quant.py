...
WORKLOADS = (
    {
        "accuracy": AccuracySpec(
            ...
            mode="global_max",
            output_indices=None,
            output_tolerances=((1e-08, 0.072), (1e-08, 0.007)),
            output_views=(
                (0, (256, 16384), (slice(0, 160, None), slice(None, None, None))),
                (1, (256,), (slice(0, 160, None),)),
            ),
            output_groups=(),
        ),
        "torch_ref": replace(_torch_ref_0, arithmetic="native"),
    ...
    },
    {
        "accuracy": AccuracySpec(
            ...
            output_tolerances=((1e-08, 0.072), (1e-08, 0.007)),
            output_views=(
                (0, (2, 16384), (slice(0, 2, None), slice(None, None, None))),
                (1, (2,), (slice(0, 2, None),)),
            ),
            output_groups=(),
        ),
    ...
    },
    {
        "accuracy": AccuracySpec(
            ...
            output_indices=None,
            output_tolerances=(),
            output_views=((0, (256, 16384), (slice(0, 160, None), slice(None, None, None))),),
            output_groups=(),
        ),
    ...
    },
    {
        "accuracy": AccuracySpec(
            ...
            output_indices=None,
            output_tolerances=(),
            output_views=((0, (2, 16384), (slice(0, 2, None), slice(None, None, None))),),
            output_groups=(),
        ),
        "torch_ref": _torch_ref_1,
        "input_specs": {
    ...
    },
    {
        ...
        "torch_ref": replace(_torch_ref_2, arithmetic="native"),
        "input_specs": {"hidden": ((1, 2, 16384), "bfloat16"), "ln_w": ((16384,), "bfloat16")},
        "input_generator": _input_generator,
    ...
    },
    {
        "accuracy": AccuracySpec(
            ...
            output_tolerances=((1e-08, 0.072), (1e-08, 0.007)),
            output_views=(
                (0, (2048, 16384), (slice(0, 2048, None), slice(None, None, None))),
                (1, (2048,), (slice(0, 2048, None),)),
            ),
            output_groups=(),
        ),
        "torch_ref": replace(_torch_ref_2, arithmetic="native"),
    ...
    },
    {
        "accuracy": AccuracySpec(
            ...
            output_indices=None,
            output_tolerances=(),
            output_views=((0, (2048, 16384), (slice(0, 2048, None), slice(None, None, None))),),
            output_groups=(),
        ),
        "torch_ref": replace(_torch_ref_3, arithmetic="native"),
        "input_specs": {
    ...
    },
    {
        ...
        "torch_ref": replace(_torch_ref_4, arithmetic="native"),
        "input_specs": {"hidden": ((1, 2, 16384), "bfloat16"), "ln_w": ((16384,), "bfloat16")},
        "input_generator": _input_generator,
