...
WORKLOADS = (
    {
        "accuracy": AccuracySpec(
            ...
            output_tolerances=(),
            output_views=(
                (0, (1, 128), (slice(None, None, None), slice(0, 128, None))),
                (1, (1, 128), (slice(None, None, None), slice(0, 128, None))),
                (2, (1, 128), (slice(None, None, None), slice(0, 128, None))),
            ),
            output_groups=((0, 1, 2),),
        ),
    ...
    },
    {
        "accuracy": AccuracySpec(
            ...
            output_tolerances=(),
            output_views=(
                (0, (1, 128), (slice(None, None, None), slice(0, 16, None))),
                (1, (1, 128), (slice(None, None, None), slice(0, 16, None))),
                (2, (1, 128), (slice(None, None, None), slice(0, 16, None))),
            ),
            output_groups=((0, 1, 2),),
        ),
    ...
    },
    {
        "accuracy": AccuracySpec(
            ...
            mode="global_max",
            output_views=(
                (0, (1, 1024), (slice(None, None, None), slice(0, 1024, None))),
                (1, (1, 1024), (slice(None, None, None), slice(0, 1024, None))),
                (2, (1, 1024), (slice(None, None, None), slice(0, 1024, None))),
            ),
            output_groups=((0, 1, 2),),
        ),
