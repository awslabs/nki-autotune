...
ACTIONS: tuple[Action, ...] = (
    ...
    (Split(), SplitOption(target_nid=85, factors=(4, 512), target_axis="d2")),
    (Reorder(), ReorderOption(outer_nid=53, inner_nid=109)),
    ...
    (CopyPropagation(), CopyPropagationOption(copy_block_nid=91, consumer_block_nid=95, consumer_operand="data")),
    ...
    (CodeMotion(), CodeMotionOption(block_nid=95, target_loop_nid=57, index=5)),
    ...
    (CodeMotion(), CodeMotionOption(block_nid=86, target_loop_nid=57, index=8)),
    (CodeMotion(), CodeMotionOption(block_nid=99, target_loop_nid=57, index=9)),
    (CodeMotion(), CodeMotionOption(block_nid=104, target_loop_nid=57, index=10)),
    (CopyPropagation(), CopyPropagationOption(copy_block_nid=63, consumer_block_nid=95, consumer_operand="data")),
    (CopyPropagation(), CopyPropagationOption(copy_block_nid=82, consumer_block_nid=86, consumer_operand="src")),
    (CopyPropagation(), CopyPropagationOption(copy_block_nid=86, consumer_block_nid=99, consumer_operand="data")),
    ...
    (SoftwarePipeline(), SoftwarePipelineOption(loop_nid=112, stages=(0, 1, 1, 1, 1, 1, 2, 3))),
