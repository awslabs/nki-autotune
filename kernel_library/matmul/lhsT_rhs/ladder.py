"""Apply, verify, dump, and profile a fixed ``lhs_T.T @ rhs`` ladder."""
...
ATOL = 5e-3
RTOL = 5e-3
INPUT_SPECS = {"lhs_T": ((SIZE, SIZE), "bfloat16"), "rhs": ((SIZE, SIZE), "bfloat16")}
...
WORKLOAD = Workload(
    input_specs=INPUT_SPECS, f_numpy=f_numpy, f_nkigym=f_nkigym, best_action_ladder=ACTIONS, historical_best_mfu=90.92
)
