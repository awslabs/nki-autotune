...
def matmul_lhs_rhsT_nkigym(lhs, rhs_T):
    ...
    # Group 2: nc_matmul [dims: d0, d2, d1]
                    ...
                    for i_block_d1 in range(4):
                        for i_ltile_d1 in range(4):
                            nisa.nc_matmul(
                                ...
                                stationary=sbuf_lhs_T[i_block_d1 * 4 + i_ltile_d1][i_block_d0 * 2 + i_ltile_d0][
                                    0:128, 0:128
                                ],
                                moving=sbuf_rhs[i_block_d1 * 4 + i_ltile_d1][i_block_d2][0:128, 0:512],
                            )
                    stage_block(sbuf_output, psum_output, i_block_d0 * 2 + i_ltile_d0, 1, i_block_d2, 1)

    # Group 3: dma_store [dims: d2, d0]
